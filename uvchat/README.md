...
- [app.py](/home/ubuntu/uvchat/uvchat/app.py)
- [config.example.json](/home/ubuntu/uvchat/uvchat/config.example.json)
- [config.json](/home/ubuntu/uvchat/uvchat/config.json)
- [requirements.txt](/home/ubuntu/uvchat/uvchat/requirements.txt)
- [run_uvchat.sh](/home/ubuntu/uvchat/uvchat/run_uvchat.sh)
- [run_uvchat.bat](/home/ubuntu/uvchat/uvchat/run_uvchat.bat)
...
```bat
cd /d E:\git\mycodebucket\uvchat
```
